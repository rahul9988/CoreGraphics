...
class GaugeView: UIView {
    ...
    var outerBezelColor = #colorLiteral(red: 0.0, green: 0.5, blue: 1, alpha: 1)
    var outerBezelWidth: CGFloat = 10
    
    var innerBezelColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    var innerBezelWidth: CGFloat = 5
    
    var insideColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    
    var segmentWidth: CGFloat = 20
    
    var segmentColors = [UIColor(red: 0, green: 0, blue: 1, alpha: 1),
